...
export function DashboardAurora() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#030712] text-slate-100 selection:bg-cyan-500 selection:text-slate-950 font-sans">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {docs.map((d: any) => (
                                <span
                                  ...
                                  className="inline-flex items-center gap-1.5 rounded-md border border-cyan-500/20 bg-slate-900/80 px-2 py-0.5 text-[10px] font-medium text-cyan-200"
                                >
                                  ...
                                  <button
                                    ...
                                    className="text-slate-400 hover:text-rose-400 text-[10px] ml-0.5 cursor-pointer"
                                  >
                                    ✕
                                  </button>
                                </span>
            ...
            <div className="space-y-6 lg:col-span-3">
              ...
              {hasActiveClaim && (
                <StaggerItem index={3} className="block lg:hidden">
                  <div className="rounded-xl border border-cyan-500/20 bg-slate-900/90 p-4 shadow-xl backdrop-blur-xl">
                      ...
                      {s.recentClaims.length === 0 ? (
                        s.claimId ? (
                          <button
                            type="button"
                            onClick={() => s.selectClaim(s.claimId || "")}
                            className="flex-none snap-start rounded-lg border border-cyan-500/40 bg-cyan-500/10 px-3.5 py-2 text-left shadow-sm min-w-[150px]"
                          >
                            <div className="flex items-center justify-between gap-1">
                            ...
                            <p className="text-[10px] text-cyan-300/60 mt-0.5 truncate">
                              ID: {s.claimId.slice(0, 8)}...
                            </p>
                          </button>
                        ) : (
                          ...
                          return (
                            <div
                              ...
                              className={cn(
                                ...
                                isSelected
                                  ? "border-cyan-400/60 bg-cyan-950/40 shadow-lg ring-1 ring-cyan-400/40"
                                  : "border-slate-800 bg-slate-950/60 hover:bg-slate-900/80 shadow-2xs"
                              )}
                            >
                              <div className="flex items-center justify-between gap-1 text-[10px]">
                                <div className="flex items-center gap-1.5 min-w-0">
                                  <span className="rounded bg-cyan-950/80 text-cyan-300 font-mono font-bold px-1.5 py-0.5 text-[9px] border border-cyan-800/60">
                                    #{shortId || "CLM001"}
                                  </span>
                                </div>
                              ...
                              {isClaimProcessing ? (
                                <div className="space-y-1 pt-1 border-t border-cyan-500/20">
                                  <div className="flex items-center justify-between text-[10px] font-semibold text-cyan-200">
                                    <span className="truncate pr-1">{currentStep}</span>
                                    <span className="font-mono font-bold text-cyan-300">{currentProgress}%</span>
                                  </div>
                                  <div className="h-1.5 w-full rounded-full bg-slate-950 overflow-hidden border border-cyan-500/20">
                                    <div
                    ...
                    <div className="rounded-2xl border border-cyan-500/20 bg-slate-900/90 p-4 shadow-xl shadow-cyan-500/5 backdrop-blur-xl">
                      <div className="flex items-center justify-between gap-2 mb-2">
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-[10px] text-cyan-300/60 truncate font-mono">Claim ID: {s.claimId ? `${s.claimId.slice(0, 8)}...` : "CLM-2026-08842"}</p>
                        </div>
                        <div className="flex items-center gap-1.5 flex-none">
                          ...
                          {s.progress >= 100 && !s.analyzing && !s.isDocumentsRequested && !s.nameMismatchWarning ? (
                            <Button
                              ...
                              size="sm"
                              className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-[11px] sm:text-xs font-bold text-white h-7 sm:h-8 px-2.5 sm:px-3 rounded-lg shadow-md border border-cyan-400/30 cursor-pointer flex items-center gap-1"
                            >
                        ...
                        <div className="mt-1.5 flex items-center justify-between gap-2">
                          <div className="flex items-center gap-1.5 min-w-0">
                            {s.progress < 100 && !s.isDocumentsRequested && (
                              <span className="h-1.5 w-1.5 rounded-full bg-cyan-400 animate-ping flex-none" />
                            )}
                            <span className="text-[11px] font-semibold text-slate-300 truncate">
                              {s.progress >= 100 ? "AI Verification Complete" : (s.stepDescription || "Analyzing documents...")}
                            </span>
                          </div>
                          <span className="font-mono font-extrabold text-[11px] text-cyan-300 bg-cyan-500/20 border border-cyan-500/30 px-2 py-0.2 rounded-full flex-none">
                            {s.progress}%
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="sm:hidden pt-3 border-t border-white/10">
                        <div className="relative flex items-center justify-between px-1">
                          ...
                          <div
                            className="absolute left-4 top-3.5 h-0.5 bg-gradient-to-r from-cyan-400 to-blue-500 transition-all duration-500 -z-0"
                            style={{
                              ...
                              >
                                <div
                                  className={cn(
                                    ...
                                    done && "bg-cyan-500 text-slate-950 shadow-cyan-500/30",
                                    current && "bg-blue-500 text-white ring-4 ring-cyan-400/30 animate-pulse scale-110 shadow-lg shadow-cyan-500/40",
                                    !done && !current && "bg-slate-900 text-slate-500 border border-slate-700"
                                  )}
                                >
                                ...
                                <span
                                  className={cn(
                                    ...
                                    current && "font-bold text-cyan-300",
                                    done && "text-slate-300",
                  ...
                  <StaggerItem index={4}>
                    <div className="rounded-2xl border border-cyan-500/20 bg-slate-900/90 p-4 shadow-xl shadow-cyan-500/5 backdrop-blur-xl">
                      ...
                      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:h-[560px] min-h-[500px]">
                        <div className="rounded-xl border border-cyan-500/20 bg-slate-950 p-2 overflow-hidden h-full flex flex-col">
                          <DocumentViewer
                            claimId={s.claimId}
                            zoom={s.zoom}
                            setZoom={s.setZoom}
                        ...
                        <div className="space-y-3 rounded-xl border border-cyan-500/20 bg-slate-950/80 p-4">
                          ...
                          <div className="pt-2">
                            ...
                            <div className="overflow-hidden rounded-lg border border-cyan-500/20 bg-slate-900">
                              <div className="max-h-[280px] overflow-y-auto scrollbar-thin">
                                <table className="w-full text-left text-[11px]">
                                  <thead className="border-b border-cyan-500/20 text-cyan-300/70 uppercase bg-slate-950/90 text-[10px] sticky top-0 z-10">
                                    <tr>
                                      <th className="py-1.5 px-2.5 bg-slate-950">Category</th>
                                      <th className="py-1.5 px-2.5 bg-slate-950">Description</th>
                                      <th className="py-1.5 px-2.5 text-right bg-slate-950">Amount</th>
                                    </tr>
                                  </thead>
                                  ...
                                  <tfoot className="sticky bottom-0 z-10">
                                    <tr className="border-t border-cyan-500/20 font-bold bg-slate-950/95 text-xs">
                                      <td colSpan={2} className="py-2 px-2.5 text-white bg-slate-950">Total Claim Amount</td>
                                      <td className="py-2 px-2.5 text-right text-cyan-400 bg-slate-950">{formatINR(s.total)}</td>
                                    </tr>
                                  </tfoot>
                                </table>
                              </div>
      ...
      {claimToDelete && (
        <div className="fixed inset-0 z-[130] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in font-sans">
          <div className="w-full max-w-sm rounded-2xl border border-cyan-500/30 bg-slate-950 p-5 shadow-2xl shadow-cyan-500/10 animate-scale-up">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-0.5">Are you sure you want to remove <span className="font-semibold text-cyan-300">{claimToDelete.name}</span>?</p>
              </div>
            </div>
